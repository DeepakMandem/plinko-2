...
function draw() {
 ...
 //text("Score : "+score,20,30);
  ...
  if(gameState=="end"){
    particles.push(new Particle(random( width/2+50, width/2-390, width/2-310, width/2-230, width/2-150, width/2-70, width/2-0, width/2+80, width/2+160, width/2+240, width/2+320, width/2+400), 10,10))=null;
